...
* Das Passwort für die Datenbank sollte im Produktivsystem angepasst werden, es wird im [docker-compose file](docker-compose.yml) gesetzt.
* Die Settings für die jwt Erstellung in [MySettings](backend/app/utility/settings.py) sollten in der Produktivumgebung angepasst werden
...
3. Security_key in [MySettings](backend/app/utility/settings.py) neu setzen
